...
import Exempt from '../Forms/drivers/Exempt';
import Categories from '../Forms/drivers/Categories';
...
class Configurations extends React.Component {
  ...
  patchData(data) {
    return api.people.updateUser(this.props.id, this.props.token, data);
  }
  ...
  render() {
    ...
    return (
      <Container>
        ...
        <Row>
          <Col sm="12" md={{ size: 9 }}>
            <h4 style={h1Style}>{t('Categories configurations')}</h4>
            <Categories
              submit={this.onFormSubmit}
              user={this.props.users[this.props.id]}
            />
          </Col>
        </Row>
        <hr />
        <Row>
          <Col sm="12" md={{ size: 9 }}>
            <h4 style={h1Style}>{t('Exempt driver configurations')}</h4>
            <Exempt
              submit={this.onFormSubmit}
              user={this.props.users[this.props.id]}
            />
...
const translateFunc = translate('translations')(Configurations);
