...
class EditMotorCarrierForm extends Component {
  constructor(props) {
    super(props);
    this.state = {
      errors: {},
      data: {
        ...
        USDOT_number: this.props.data.USDOT_number,
        multiday_basis_used: this.props.data.multiday_basis_used
      },
      isLoading: false,
      redirectTo: false
    }
...
EditMotorCarrierForm.propTypes = {
  submit: PropTypes.func.isRequired
};

export default EditMotorCarrierForm;
